    ...
    : QWidget(parent)
{
    ...
    shapeComboBox->addItem(tr("线段"),PaintArea::Line);
    shapeComboBox->addItem(tr("矩形"),PaintArea::Rectangle);
    shapeComboBox->addItem(tr("圆角矩形"),PaintArea::RoundRect);
    shapeComboBox->addItem(tr("椭圆"),PaintArea::Ellipse);
    shapeComboBox->addItem(tr("多边形"),PaintArea::Polygon);
    shapeComboBox->addItem(tr("折线"),PaintArea::Polyline);
    shapeComboBox->addItem(tr("点"),PaintArea::Points);
    shapeComboBox->addItem(tr("圆弧"),PaintArea::Arc);
    shapeComboBox->addItem(tr("路径"),PaintArea::Path);
    shapeComboBox->addItem(tr("文本"),PaintArea::Text);
    shapeComboBox->addItem(tr("图像"),PaintArea::Pixmap);
    ...
    rightLayout->addWidget(brushColorLabel,7,0);
    rightLayout->addWidget(brushColorFrame,7,1);
    rightLayout->addWidget(brushColorBtn,7,2);
